 ...
 * FilterBar, CreateItemDialog, and PromoteActionDialog.
 *
 * @module components/projects/BoardContent
...
/**
 * BoardContent — kanban-first board tab for the Tasks page.
 *
 * Displays all project items across projects with kanban as the default
 * view mode. Supports list/kanban toggle, filtering, search, and item
 * creation. TriageTray is NOT included — triage has its own tab.
 *
 * @module components/projects/BoardContent
 * @since March 2026
 */
export function BoardContent() {
  ...
  logger.debug('Board loaded', { viewMode, itemCount: items.length });
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Items — Kanban (default) or List view */}
      {viewMode === 'kanban' ? (
        <TaskKanbanBoard
          items={filteredItems}
          isLoading={isLoading}
