...
### 2.4 — Dedicated Browse Pages (Insights, News, Links)
...
- `/inbox?tab=ideas` — Full ideas feed (already exists as IdeasFeed)
- `/inbox?tab=insights` — Full insights feed (already exists as InsightsFeed)
- `/inbox?tab=news` — Full news feed (already exists as NewsFeed)
- `/inbox?tab=links` — Full links feed with save/dismiss/open tracking
...
- New: `src/components/inbox/LinksFeed.tsx` — Full links browse page
